...
## Тестирование.
### Тесты находятся в пакете tests. Наззвания модулей тестов соответствует названиям модулей разработки. Использован фреймворк тестирования pytest. Для тестирования processing.py использована фикстура. Использована параметризация тестов для widget.py
### Например:

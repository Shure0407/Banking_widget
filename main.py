...
# 'C:/Users/Aleksandr/PycharmProjects/PythonProject/data/transactions.csv')
# data_csv = tables.tables_csv(
# 'C:/Users/Aleksandr/PycharmProjects/PythonProject/data/transactions_three_str.csv')
# data_csv = tables.tables_csv(
# 'C:/Users/Aleksandr/PycharmProjects/PythonProject/data/transactions_not_list.csv')
# data_csv = tables.tables_csv(
# 'C:/Users/Aleksandr/PycharmProjects/PythonProject/data/transactions_empty.csv') # пустой файл
# print(data_csv)

# data_excel = tables.tables_excel(
# 'C:/Users/Aleksandr/PycharmProjects/PythonProject/data/transactions_excel.xlsx')
data_excel = tables.tables_excel(
